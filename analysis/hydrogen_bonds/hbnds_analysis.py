...
if __name__ == "__main__":
    ...
    MAIN_TITLE = 'Comparative Analysis of H-Bonds between Protein-Ligand'
    X_AXIS_LABEL = 'Time (ns)'
    Y_AXIS_LABEL = 'Number of H-Bonds)'
    LEGEND_LABEL = 'H-Bonds'
    OUTPUT_FILENAME = 'h_bonds_subplot_comparison.png'
    ...
    plot_analysis_on_ax(axes[0, 1], 
                        data_file='hedragenin_hbonds.agr', 
    ...
    plot_analysis_on_ax(axes[1, 1], 
                        data_file='maslinic_acid_hbonds.agr', 
...
# Save the final figure as EPS
    output_filename = 'hbonds_comparison.eps'
