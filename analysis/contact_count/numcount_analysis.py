...
if __name__ == "__main__":
    ...
    MAIN_TITLE = 'Comparative Analysis of Number of Contacts < 0.6nm'
    ...
    OUTPUT_FILENAME = 'numcount_comparison.png'
    ...
    plot_analysis_on_ax(axes[0, 1], 
                        data_file='hedragenin_numcont.xvg', 
    ...
    plot_analysis_on_ax(axes[1, 1], 
                        data_file='maslinic_acid_numcont.xvg', 
...
# Save the final figure as EPS
    output_filename = 'numcount_subplot_comparison.eps'
