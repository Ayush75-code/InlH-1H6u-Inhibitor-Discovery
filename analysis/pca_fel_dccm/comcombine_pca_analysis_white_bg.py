...
for idx, (system_name, (xvg_file, _)) in enumerate(systems.items()):
    ax = fig.add_axes(pca_positions[idx], facecolor='white')  # White subplot background
...
for idx, (system_name, (_, xpm_file)) in enumerate(systems.items()):
    ax = fig.add_axes(fel_positions[idx], facecolor='white')  # White subplot background
...
# Save with WHITE background and high quality - multiple formats
OUTPUT_FILENAME = 'combined_pca_fel_publication_FIXED'
