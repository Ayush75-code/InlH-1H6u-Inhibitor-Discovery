...
# Systems data
systems = {
    'A) Control Complex': 'control_2d_projection.xvg',
    'B) Hedragenin Analogue Complex': 'hedragenin_2d_projection.xvg', 
    'C) Lupeol Analogue Complex': 'lupeol_2d_projection.xvg',
    'D) Maslinic Acid Analogue Complex': 'maslinic_acid_2d_projection.xvg'
}
