...
if __name__ == "__main__":
    ...
    MAIN_TITLE = 'Comparative Analysis of Minimum Distance between Proteian and Ligand '
    X_AXIS_LABEL = 'Time (ns)'
    Y_AXIS_LABEL = 'Distance (nm)'
    
    # --- TO REMOVE THE LEGEND, SET THIS TO '' ---
    LEGEND_LABEL = 'Protein-UNL' # Was 'Rg', now it's an empty string
    
    OUTPUT_FILENAME = 'mindis_subplot_comparison.png'
    ...
    plot_analysis_on_ax(axes[0, 0], 
                        data_file='Control_mindist_prot_lig.xvg', 
    ...
    plot_analysis_on_ax(axes[0, 1], 
                        data_file='hedragenin_mindist_prot_lig.xvg', 
    ...
    plot_analysis_on_ax(axes[1, 0], 
                        data_file='lupeol_mindist_prot_lig.xvg', 
    ...
    plot_analysis_on_ax(axes[1, 1], 
                        data_file='maslinic_acid_mindist_prot_lig.xvg', 
...
# Save the final figure as EPS
    output_filename = 'minidis_subplot_comparison.eps'
