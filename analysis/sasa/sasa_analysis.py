...
if __name__ == "__main__":
    ...
    MAIN_TITLE = 'Comparative Analysis of Solvent Accessible Surface Area'
    X_AXIS_LABEL = 'Time (ns)'
    Y_AXIS_LABEL = 'Area (nm²)'
    
    # --- TO REMOVE THE LEGEND, SET THIS TO '' ---
    LEGEND_LABEL = '' # Was 'Rg', now it's an empty string
    
    OUTPUT_FILENAME = 'SASA_subplot_comparison.png'
    ...
    plot_analysis_on_ax(axes[1, 1], 
                        data_file='maslinic_acid_sasa.xvg', 
...
# Save the final figure as EPS
    output_filename = 'SASA_subplot_comparison.eps'
